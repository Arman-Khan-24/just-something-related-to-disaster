  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6">
      ...
      <div className="relative z-10 text-center">
        ...
        >
          Stay Safe with
          <span className="text-blue-500"> DisasterGuard</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Your personal disaster preparedness companion. Get real-time alerts, emergency plans, and resources to protect what matters most.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
